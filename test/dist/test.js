...
var writablePropertySymbols = require( './../../dist' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof writablePropertySymbols, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function returns an array of an object\'s own writable symbol properties', function test( t ) {
	var hasSymbols;
	var expected;
	var actual;
	var syms;
	...
	actual = writablePropertySymbols( obj );
...
tape( 'the function returns an array of an object\'s own writable symbol properties (mock)', function test( t ) {
	var writablePropertySymbols;
	var expected;
	var actual;
	var syms;
	var obj;
	...
	writablePropertySymbols = proxyquire( './../dist/main.js', {
...
tape( 'the function returns an empty array if provided `null` or `undefined`', function test( t ) {
	...
	for ( i = 0; i < values.length; i++ ) {
		actual = writablePropertySymbols( values[ i ] );
